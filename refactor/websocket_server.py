...
async def handle_connection(websocket, path):
    ...
    if client_id not in connections:
        ...
        threading.Thread(target=start_rabbit_consumer, args=(client_id,)).start()
...
def start_rabbit_consumer(client_id):
    subprocess.run(["python3", "rabbit_consumer.py", client_id])
...
start_server_ws = websockets.serve(handle_connection, "localhost", 8765)
